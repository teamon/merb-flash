...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.textile", "Rakefile", "TODO", "lib/merb-flash", "lib/merb-flash/request_controller.rb", "lib/merb-flash.rb", "spec/merb-flash_spec.rb", "spec/spec.opts", "spec/spec_helper.rb"]
  s.has_rdoc = true
